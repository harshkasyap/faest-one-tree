...
typedef struct
{
	block192t keys[ROUNDS_192 + 1];
} rijndael192_round_keys2;

typedef struct
{
	block256 keys[ROUNDS_256 + 1];
} rijndael256_round_keys2;

union CCR_CTX {
  EVP_CIPHER_CTX* evp_ctx;
  rijndael192_round_keys2 r192_round_keys;
  rijndael256_round_keys2 r256_round_keys;
};
