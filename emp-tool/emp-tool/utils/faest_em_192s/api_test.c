...
int main(void) {
  ...
  printf("CCR_MMO_Rijndael192: %f cycles\n", avg_cycle);

  avg_time = run_test_time(repetition);
  printf("CCR_MMO_Rijndael192: %f ns\n", avg_time);

  avg_cycle = run_test_naive(repetition);
  printf("CCR_MMO_Rijndael192(Naive): %f cycles\n", avg_cycle);

  avg_time = run_test_time_naive(repetition);
  printf("CCR_MMO_Rijndael192(Naive): %f ns\n", avg_time);

  avg_cycle = run_test_rijndael192(repetition);
  printf("rijndael192_encrypt_block: %f cycles\n", avg_cycle);
  /////////////////////////////////////
